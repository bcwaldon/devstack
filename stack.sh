...
if is_service_enabled g-reg; then
    ...
    iniset $GLANCE_REGISTRY_CONF paste_deploy flavor keystone+cachemanagement
    ...
    iniset $GLANCE_CACHE_CONF DEFAULT auth_url $KEYSTONE_AUTH_PROTOCOL://$KEYSTONE_AUTH_HOST:$KEYSTONE_AUTH_PORT/
